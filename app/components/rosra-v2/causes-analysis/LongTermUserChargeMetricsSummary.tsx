...
interface LongTermUserChargeMetricsSummaryProps {
  longTermCalculations: {
...
export default function LongTermUserChargeMetricsSummary({ 
  longTermCalculations, 
  currencySymbol 
}: LongTermUserChargeMetricsSummaryProps) {
  // Get gap breakdown values from props
  const gapBreakdown = longTermCalculations.gapBreakdown || {
    complianceGap: 0,
    rateGap: 0,
    combinedGaps: 0
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        ...
        <div className="flex rounded-lg overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1 p-3">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
              {formatCurrency(longTermCalculations.actualRevenue, currencySymbol)}
            </p>
          </div>
        </div>
        ...
        <div className="flex rounded-lg overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1 p-3">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
              {formatCurrency(longTermCalculations.potentialRevenue, currencySymbol)}
            </p>
          </div>
        </div>
        ...
        <div className="flex rounded-lg overflow-hidden shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div className="flex-1 p-3">
            ...
            <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">
              {formatCurrency(longTermCalculations.gap, currencySymbol)}
            </p>
          </div>
        </div>
      </div>
